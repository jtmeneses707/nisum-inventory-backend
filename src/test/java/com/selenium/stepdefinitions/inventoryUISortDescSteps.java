...
public class inventoryUISortDescSteps {
WebDriver driver;
    ...
    public void i_should_be_able_to_see_all_items_in_its_respective_category_in_descending_order() throws InterruptedException {
        var m = driver.findElements(By.tagName("mat-header-cell"));
        ...
        for(int i =0; i < arr.length; i++){
            actualUPC[i]=arr[i][0];
            System.out.println(actualUPC[i]);
        }
